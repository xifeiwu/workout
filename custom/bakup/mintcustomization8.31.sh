...
#sed -i '/gparted/d' extract-cd/casper/filesystem.manifest-desktop
#sed -i '/libdebian-installer/d' filesystem.manifest-desktop
#sed -i '/user-setup/d' filesystem.manifest-desktop
